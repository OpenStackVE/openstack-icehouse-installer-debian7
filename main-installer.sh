#!/bin/bash
#
# Instalador desatendido para Openstack Havana sobre DEBIAN 7
...
"install")
	...
	echo "Versión 1.1.5.deb7 \"Snow Lynx\" - Enero 19, 2015"
	echo ""
	...
	echo "  * http://archive.gpkhost.com/debian icehouse main"
	echo "  * http://archive.gplhost.com/debian icehouse-backports main"
